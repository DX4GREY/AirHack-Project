...
#define OBFUSCATE(data) (data)  // Ini hanya contoh. Ganti dengan logika obfuscate yang sesuai.
#define OBFUSCATE_KEY "your_key_here" // Ganti dengan kunci yang sesuai.
